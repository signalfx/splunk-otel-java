...
- OpenTelemetry Instrumentation for Java has been updated to version [2.30.0](https://github.com/open-telemetry/opentelemetry-java-instrumentation/releases/tag/v2.29.0).
...
- OpenTelemetry Java SDK has been updated to version 1.56.0.
...
- OpenTelemetry Java SDK has been updated to version 1.55.0.
- OpenTelemetry Instrumentation for Java has been updated to version 2.21.0.
...
- OpenTelemetry Instrumentation for Java has been updated to version 2.18.1.

## v2.17.1 - 2025-07-11

### General

- OpenTelemetry Instrumentation for Java has been updated to version 2.17.1.

## v2.17.0 - 2025-06-28

### General

- OpenTelemetry Java SDK has been updated to version 1.51.0.
- OpenTelemetry Instrumentation for Java has been updated to version 2.17.0.
...
- OpenTelemetry Instrumentation for Java has been updated to version 2.13.3.

## v2.13.0 - 2025-02-19

### General

- OpenTelemetry Java SDK has been updated to version 1.47.0.
- OpenTelemetry Instrumentation for Java has been updated to version 2.13.1.
...
2.5.0 is the first non alpha release in the 2.x series. Please consult the release notes of
2.0.0-alpha for the breaking changes when you are switching from the 1.x version of the agent.
