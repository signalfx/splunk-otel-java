...
<p align="center">
  ...
  <a href="https://github.com/open-telemetry/opentelemetry-java-instrumentation/releases/tag/v1.11.0">
    <img alt="OpenTelemetry Instrumentation for Java Version" src="https://img.shields.io/badge/otel-1.11.0-blueviolet?style=for-the-badge">
  </a>
...
The Splunk Distribution of OpenTelemetry Java version <!--SPLUNK_VERSION-->1.8.0<!--SPLUNK_VERSION--> is compatible
with:

* OpenTelemetry API version <!--OTEL_VERSION-->1.11.0<!--OTEL_VERSION-->
* OpenTelemetry Instrumentation for Java version <!--OTEL_INSTRUMENTATION_VERSION-->1.11.0<!--OTEL_INSTRUMENTATION_VERSION-->
