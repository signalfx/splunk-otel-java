...
The following documentation refers to the in-development version of `splunk-otel-java`. Docs for the latest version ([v1.17.0](https://github.com/signalfx/splunk-otel-java/releases/latest)) can be found [here](https://github.com/signalfx/splunk-otel-java/blob/v1.17.0/README.md).
...
The Splunk Distribution of OpenTelemetry Java version <!--SPLUNK_VERSION-->1.17.0<!--SPLUNK_VERSION--> is compatible
with:
...
We publish [snapshot builds](https://oss.sonatype.org/content/repositories/snapshots/com/splunk/splunk-otel-javaagent/1.18.0-SNAPSHOT/)
