...
The Splunk Distribution of OpenTelemetry Java version <!--SPLUNK_VERSION-->1.9.0<!--SPLUNK_VERSION--> is compatible
with:

* OpenTelemetry API version <!--OTEL_VERSION-->1.12.0<!--OTEL_VERSION-->
* OpenTelemetry Instrumentation for Java version <!--OTEL_INSTRUMENTATION_VERSION-->1.12.0<!--OTEL_INSTRUMENTATION_VERSION-->
