...
|-----------------------------------|-----------------------------------|---------------------------------------------------------------------------------------------------------------------|
| otel.exporter=jaeger              | OTEL_EXPORTER=jaeger              | Optional: Select the Jaeger exporter for gRPC capable environments. This should not be set in a default Kubernetes setuip.                                                                                          |
