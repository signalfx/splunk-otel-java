...
dependencies {
  ...
  implementation("io.opentelemetry.instrumentation:gradle-plugins:1.24.0-alpha-SNAPSHOT")
  implementation("io.spring.gradle:dependency-management-plugin:1.1.0")

  // keep these versions in sync with settings.gradle.kts
  implementation("gradle.plugin.com.github.johnrengelman:shadow:8.1.0")
}
