...
package com.splunk.opentelemetry.internal;
...
/**
 * This class is copied from the upstream core internals. It allows us to call getResource() and
 * getConfig() on the AutoConfiguredOpenTelemetrySdk. This is merely here as a stop-gap measure
 * until other means are in place.
 *
...
public final class AutoConfigureUtil {
  ...
  public static ConfigProperties getConfig(AutoConfiguredOpenTelemetrySdk sdk) {
    try {
      ...
      return (ConfigProperties) method.invoke(sdk);
