...
/**
 * Configuration for {@link CustomSignalFxMeterRegistry}.
 *
 * @author Jon Schneider
 */
public interface CustomSignalFxConfig extends StepRegistryConfig {
  ...
  default Validated<?> validate() {
    return checkAll(this,
        ...
        checkRequired("accessToken", CustomSignalFxConfig::accessToken),
        checkRequired("uri", CustomSignalFxConfig::uri),
        checkRequired("source", CustomSignalFxConfig::source)
    );
  }
}