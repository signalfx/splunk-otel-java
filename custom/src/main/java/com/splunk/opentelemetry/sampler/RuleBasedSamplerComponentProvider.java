...
public class RuleBasedSamplerComponentProvider implements ComponentProvider<Sampler> {
  private static final Logger logger = Logger.getLogger(RuleBasedSamplerComponentProvider.class.getName());
  ...
  public Sampler create(DeclarativeConfigProperties samplerProperties) {
    ...
    Map<String, Object> configPropertiesMap = samplerConfigProperties != null ? DeclarativeConfigProperties.toMap(samplerConfigProperties) : new HashMap<>();
    ObjectMapper objectMapper = new ObjectMapper();
    RuleBasedSamplerConfig config = objectMapper.convertValue(configPropertiesMap, RuleBasedSamplerConfig.class);
