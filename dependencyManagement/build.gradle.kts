...
val otelInstrumentationVersion = "1.24.0-SNAPSHOT"
...
dependencies {
  ...
  api(enforcedPlatform("com.google.protobuf:protobuf-bom:3.22.1"))
  ...
  constraints {
    ...
    api("com.signalfx.public:signalfx-java:1.0.29")
