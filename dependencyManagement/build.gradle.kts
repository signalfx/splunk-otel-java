...
val otelContribAlphaVersion = "1.26.0-alpha"
...
dependencies {
  ...
  // BOMs
  api(enforcedPlatform("com.fasterxml.jackson:jackson-bom:2.15.1"))
  api(enforcedPlatform("com.google.protobuf:protobuf-bom:3.23.1"))
