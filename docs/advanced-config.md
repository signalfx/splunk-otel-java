...
| `splunk.metrics.force_full_commandline` | `SPLUNK_METRICS_FORCE_FULL_COMMANDLINE` | `false`                 | Experimental | Forces the full commandline to be included as a resource attribute for all metrics. Default truncates to 255 chars.                                                                                                                                           |
