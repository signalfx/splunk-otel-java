...
| `splunk.metrics.implementation`        | `SPLUNK_METRICS_IMPLEMENTATION`        | `micrometer`            | Experimental | The metrics implementation used by agent. Valid values are `micrometer` and `opentelemetry`.                                                                                                                                                                  |
