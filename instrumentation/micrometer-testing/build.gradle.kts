...
dependencies {
  ...
  add("version13TestImplementation", "io.micrometer:micrometer-core:1.9.5")
  add("version14TestImplementation", "io.micrometer:micrometer-core:1.9.5")
  add("version15TestImplementation", "io.micrometer:micrometer-core:1.9.5")
  add("version16TestImplementation", "io.micrometer:micrometer-core:1.9.5")
  add("version17TestImplementation", "io.micrometer:micrometer-core:1.9.5")
