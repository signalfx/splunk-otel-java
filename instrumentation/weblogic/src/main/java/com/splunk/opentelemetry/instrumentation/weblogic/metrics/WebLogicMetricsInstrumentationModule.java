...
public class WebLogicMetricsInstrumentationModule extends MetricsDependentInstrumentationModule {
  ...
  public List<TypeInstrumentation> typeInstrumentations() {
    return singletonList(new ServerLifecycleListenerInstrumentation());
  }
}
