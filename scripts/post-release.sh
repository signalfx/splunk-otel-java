...
The documentation below refers to the in development version of this package. Docs for the latest version ([v${splunk_current_version}](https://github.com/signalfx/splunk-otel-java/releases/tag/v${splunk_current_version})) can be found [here](https://github.com/signalfx/splunk-otel-java/blob/v${splunk_current_version}/README.md).
