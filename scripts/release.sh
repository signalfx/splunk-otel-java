...
build_project() {
  ...
  mv "agent-secureapp-bundle/build/libs/splunk-otel-javaagent-secureapp-${release_version}.jar" dist/splunk-otel-javaagent-secureapp.jar
  mv "agent-secureapp-bundle/build/libs/splunk-otel-javaagent-secureapp-${release_version}.jar.asc" dist/splunk-otel-javaagent-secureapp.jar.asc
