...
public class TomcatSmokeTest extends AppServerTest {
  ...
  private static Stream<Arguments> supportedConfigurations() {
    return configurations("tomcat")
        ...
        .otelLinux("9.0.111", TOMCAT9_SERVER_ATTRIBUTES, VMS_HOTSPOT, "8", "11")
        .otelLinux("10.1.48", TOMCAT10_SERVER_ATTRIBUTES, VMS_HOTSPOT, "11", "17", "21")
        .otelLinux("10.1.48", TOMCAT10_SERVER_ATTRIBUTES, VMS_OPENJ9, "11")
        .otelWindows("7.0.109", TOMCAT7_SERVER_ATTRIBUTES, VMS_HOTSPOT, "8")
        .otelWindows("8.5.98", TOMCAT8_SERVER_ATTRIBUTES, VMS_HOTSPOT, "8", "11")
        .otelWindows("9.0.111", TOMCAT9_SERVER_ATTRIBUTES, VMS_HOTSPOT, "8", "11")
        .otelWindows("10.1.48", TOMCAT10_SERVER_ATTRIBUTES, VMS_HOTSPOT, "11", "17", "21")
        .stream();
  }
