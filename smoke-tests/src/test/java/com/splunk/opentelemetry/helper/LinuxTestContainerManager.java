...
public class LinuxTestContainerManager extends AbstractTestContainerManager {
  ...
  public void startEnvironment() {
    ...
    backend =
        new GenericContainer<>(
                DockerImageName.parse(
                    "ghcr.io/open-telemetry/opentelemetry-java-instrumentation/smoke-test-fake-backend:20251117.19421579342"))
    ...
    hecBackend =
        new GenericContainer<>(DockerImageName.parse("mockserver/mockserver:6.0.0"))
